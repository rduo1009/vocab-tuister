...
This file defines the instructions and working context for **Google Antigravity** when interacting with this repository.

It provides guidance on:

- How to understand and navigate the codebase
- Project-specific conventions and expectations
- How Antigravity should reason about changes, fixes, and additions

These instructions are shared across AI tooling used in this repository.
The content is derived from a common agent-instructions template inspired by https://agentsmd.net/.
