...
require (
	github.com/charmbracelet/x/exp/golden v0.0.0-20251109135125-8916d276318f // test
	github.com/charmbracelet/x/exp/teatest/v2 v2.0.0-20260316093931-f2fb44ab3145 // test
