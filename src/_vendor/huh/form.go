...
// ComponentModel is a variant of ComponentModel which uses string views instead of tea.View.
//
...
func (f *Form) Update(msg tea.Msg) (ComponentModel, tea.Cmd) {
	...
	case nextGroupMsg:
		...
		submit := func() (ComponentModel, tea.Cmd) {
			f.quitting = true
