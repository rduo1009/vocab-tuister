...
func insertCharacter(model *editorModel, char string) (util.ComponentModel, tea.Cmd) {
	model.buffer.saveUndoState(model.cursor)
...
func addCommandCharacter(model *editorModel, char string) (util.ComponentModel, tea.Cmd) {
