...
//go:generate poetry run python3 ../../../scripts/create_settings_json.py
//go:generate gojsonstruct --typename SessionConfig --package-name pkg --file-header "// Code generated by gojsonstruct; DO NOT EDIT." -o ../../pkg/sessionconfig.go ../../../scripts/json_output/Settings_sample.json
