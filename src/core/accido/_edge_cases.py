...
DERIVED_IRREGULAR_CHANGES: Final[
    ...
    "sum": lambda x: DictChanges(  # e.g. adsum, adesse, adfui, adfuturus
        # perfective indicative and subjunctive, imperfect subjunctive are regular
        replacements={
            "Vpreactindsg2": x[0] + "es",     "Vpreactindsg3": x[0] + "est",
            "Vpreactindpl1": x[0] + "sumus",  "Vpreactindpl2": x[0] + "estis",  "Vpreactindpl3": x[0] + "sunt",
            "Vimpactindsg1": x[0] + "eram",   "Vimpactindsg2": x[0] + "eras",   "Vimpactindsg3": x[0] + "erat",
            "Vimpactindpl1": x[0] + "eramus", "Vimpactindpl2": x[0] + "eratis", "Vimpactindpl3": x[0] + "erant",
            "Vfutactindsg1": x[0] + "ero",    "Vfutactindsg2": x[0] + "eris",   "Vfutactindsg3": x[0] + "erit",
            "Vfutactindpl1": x[0] + "erimus", "Vfutactindpl2": x[0] + "eritis", "Vfutactindpl3": x[0] + "erunt",
            "Vpreactsbjsg1": x[0] + "sim",    "Vpreactsbjsg2": x[0] + "sis",    "Vpreactsbjsg3": x[0] + "sit",
            "Vpreactsbjpl1": x[0] + "simus",  "Vpreactsbjpl2": x[0] + "sitis",  "Vpreactsbjpl3": x[0] + "sint",
            "Vpreactipesg2": x[0] + "es",     "Vpreactipepl2": x[0] + "este",
            "Vfutactipesg2": x[0] + "esto",   "Vfutactipesg3": x[0] + "esto",
            "Vfutactipepl2": x[0] + "estote", "Vfutactipepl3": x[0] + "sunto",
            "Vfutactinf   ": MultipleEndings(
                regular=x[3] + "futurum esse", second=x[3] + "fore"
            ),
        },
        additions={},
        # no passives, present participles
    ...
    "fero": lambda x: DictChanges(  # e.g. affero, afferre, attuli, allatus
        # some forms are irregular
        replacements={
            "Vpreactindsg2": x[0] + "fers",     "Vpreactindsg3": x[0] + "fert",
            "Vpreactindpl2": x[0] + "fertis",
            "Vprepasindsg2": x[0] + "ferris",   "Vprepasindsg3": x[0] + "fertur",
            "Vpreactipesg2": x[0] + "fer",      "Vpreactipepl2": x[0] + "ferte",
            "Vprepasipesg2": x[0] + "ferre",    "Vprepasipepl2": x[0] + "ferimini",
            "Vfutactipesg2": x[0] + "ferto",    "Vfutactipesg3": x[0] + "ferto",
            "Vfutactipepl2": x[0] + "fertote",  "Vfutactipepl3": x[0] + "ferunto",
            "Vfutpasipesg2": x[0] + "fertor",   "Vfutpasipesg3": x[0] + "fertor",
            "Vfutpasipepl3": x[0] + "feruntor",
            "Vprepasinf   ": x[0] + "ferri",
        },
        additions={},
        deletions=set(),
    ),
    "eo": lambda x: DictChanges(  # e.g. adeo, adire, adii, aditus
        # various forms are regular throughout
        replacements={
            "Vpreactindpl3"   : x[0] + "eunt",
            "Vimpactindsg1"   : x[0] + "ibam",    "Vimpactindsg2"   : x[0] + "ibas",     "Vimpactindsg3"   : x[0] + "ibat",
            "Vimpactindpl1"   : x[0] + "ibamus",  "Vimpactindpl2"   : x[0] + "ibatis",   "Vimpactindpl3"   : x[0] + "ibant",
            "Vfutactindsg1"   : x[0] + "ibo",     "Vfutactindsg2"   : x[0] + "ibis",     "Vfutactindsg3"   : x[0] + "ibit",
            "Vfutactindpl1"   : x[0] + "ibimus",  "Vfutactindpl2"   : x[0] + "ibitis",   "Vfutactindpl3"   : x[0] + "ibunt",
            "Vperactindsg2"   : x[2] + "isti",    "Vperactindpl2"   : x[2] + "istis",
            "Vprepasindsg1"   : x[0] + "eor",     "Vprepasindpl3"   : x[0] + "euntur",
            "Vimppasindsg1"   : x[0] + "ibar",    "Vimppasindsg2"   : x[0] + "ibaris",   "Vimppasindsg3"   : x[0] + "ibatur",
            "Vimppasindpl1"   : x[0] + "ibamur",  "Vimppasindpl2"   : x[0] + "ibamini",  "Vimppasindpl3"   : x[0] + "ibantur",
            "Vfutpasindsg1"   : x[0] + "ibor",    "Vfutpasindsg2"   : x[0] + "iberis",   "Vfutpasindsg3"   : x[0] + "ibitur",
            "Vfutpasindpl1"   : x[0] + "ibimur",  "Vfutpasindpl2"   : x[0] + "ibimini",  "Vfutpasindpl3"   : x[0] + "ibuntur",
            "Vpreactsbjsg1"   : x[0] + "eam",     "Vpreactsbjsg2"   : x[0] + "eas",      "Vpreactsbjsg3"   : x[0] + "eat",
            "Vpreactsbjpl1"   : x[0] + "eamus",   "Vpreactsbjpl2"   : x[0] + "eatis",    "Vpreactsbjpl3"   : x[0] + "eant",
            "Vplpactsbjsg1"   : x[2] + "issem",   "Vplpactsbjsg2"   : x[2] + "isses",    "Vplpactsbjsg3"   : x[2] + "isset",
            "Vplpactsbjpl1"   : x[2] + "issemus", "Vplpactsbjpl2"   : x[2] + "issetis",  "Vplpactsbjpl3"   : x[2] + "issent",
            "Vprepassbjsg1"   : x[0] + "ear",     "Vprepassbjsg2"   : x[0] + "earis",    "Vprepassbjsg3"   : x[0] + "eatur",
            "Vprepassbjpl1"   : x[0] + "eamur",   "Vprepassbjpl2"   : x[0] + "eamini",   "Vprepassbjpl3"   : x[0] + "eantur",
            "Vfutactipepl3"   : x[0] + "eunto",   "Vfutpasipepl3"   : x[0] + "euntor",
            "Vperactinf   "   : x[2] + "isse",
            "Vpreactptcmaccsg": x[0] + "euntem",  "Vpreactptcmgensg": x[0] + "euntis",   "Vpreactptcmdatsg": x[0] + "eunti",
            "Vpreactptcmablsg": MultipleEndings(regular=x[0] + "eunti", absolute=x[0] + "eunte"),
            "Vpreactptcmnompl": x[0] + "euntes",  "Vpreactptcmvocpl": x[0] + "euntes",   "Vpreactptcmaccpl": x[0] + "euntes",
            "Vpreactptcmgenpl": x[0] + "euntium", "Vpreactptcmdatpl": x[0] + "euntibus", "Vpreactptcmablpl": x[0] + "euntibus",
            "Vpreactptcfaccsg": x[0] + "euntem",  "Vpreactptcfgensg": x[0] + "euntis",   "Vpreactptcfdatsg": x[0] + "eunti",
            "Vpreactptcfablsg": MultipleEndings(regular=x[0] + "eunti", absolute=x[0] + "eunte"),
            "Vpreactptcfnompl": x[0] + "euntes",  "Vpreactptcfvocpl": x[0] + "euntes",   "Vpreactptcfaccpl": x[0] + "euntes",
            "Vpreactptcfgenpl": x[0] + "euntium", "Vpreactptcfdatpl": x[0] + "euntibus", "Vpreactptcfablpl": x[0] + "euntibus",
            "Vpreactptcngensg": x[0] + "euntis",  "Vpreactptcndatsg": x[0] + "eunti",
            "Vpreactptcnablsg": MultipleEndings(regular=x[0] + "eunti", absolute=x[0] + "eunte"),
            "Vpreactptcnnompl": x[0] + "euntia",  "Vpreactptcnvocpl": x[0] + "euntia",   "Vpreactptcnaccpl": x[0] + "euntia",
            "Vpreactptcngenpl": x[0] + "euntium", "Vpreactptcndatpl": x[0] + "euntibus", "Vpreactptcnablpl": x[0] + "euntibus",
        },
        additions={},
        deletions=set(),
    ),
    "eo_impersonal_passive": lambda x: DictChanges(  # e.g. abeo, abire, abii, abitus
        ...
        replacements={
            ...
            "Vfutactindsg1"   : x[0] + "ibo",     "Vfutactindsg2"   : x[0] + "ibis",     "Vfutactindsg3"   : x[0] + "ibit",
            "Vfutactindpl1"   : x[0] + "ibimus",  "Vfutactindpl2"   : x[0] + "ibitis",   "Vfutactindpl3"   : x[0] + "ibunt",
            "Vimppasindsg3"   : x[0] + "ibatur",
            "Vfutpasindsg3"   : x[0] + "ibitur",
            "Vperactindsg2"   : x[2] + "isti",    "Vperactindpl2"   : x[2] + "istis",
            "Vpreactsbjsg3"   : x[0] + "eat",
            "Vplpactsbjsg1"   : x[2] + "issem",   "Vplpactsbjsg2"   : x[2] + "isses",    "Vplpactsbjsg3"   : x[2] + "isset",
            "Vplpactsbjpl1"   : x[2] + "issemus", "Vplpactsbjpl2"   : x[2] + "issetis",  "Vplpactsbjpl3"   : x[2] + "issent",
            "Vpreactptcmaccsg": x[0] + "euntem",  "Vpreactptcmgensg": x[0] + "euntis",   "Vpreactptcmdatsg": x[0] + "eunti",
            "Vpreactptcmablsg": MultipleEndings(regular=x[0] + "eunti", absolute=x[0] + "eunte"),
    ...
    "facio": lambda x: DictChanges( # patefacio, patefacere, patefeci, patefactus
        # suppletive with 'fieri'
        replacements={
            "Vprepasindsg1": x[0] + "fio",      "Vprepasindsg2": x[0] + "fis",      "Vprepasindsg3": x[0] + "fit",
            "Vprepasindpl1": x[0] + "fimus",    "Vprepasindpl2": x[0] + "fitis",    "Vprepasindpl3": x[0] + "fiunt",
            "Vimppasindsg1": x[0] + "fiebam",   "Vimppasindsg2": x[0] + "fiebas",   "Vimppasindsg3": x[0] + "fiebat",
            "Vimppasindpl1": x[0] + "fiebamus", "Vimppasindpl2": x[0] + "fiebatis", "Vimppasindpl3": x[0] + "fiebant",
            "Vfutpasindsg1": x[0] + "fiam",     "Vfutpasindsg2": x[0] + "fies",     "Vfutpasindsg3": x[0] + "fiet",
            "Vfutpasindpl1": x[0] + "fiemus",   "Vfutpasindpl2": x[0] + "fietis",   "Vfutpasindpl3": x[0] + "fient",
            "Vprepassbjsg1": x[0] + "fiam",     "Vprepassbjsg2": x[0] + "fias",     "Vprepassbjsg3": x[0] + "fiat",
            "Vprepassbjpl1": x[0] + "fiamus",   "Vprepassbjpl2": x[0] + "fiatis",   "Vprepassbjpl3": x[0] + "fiant",
            "Vimppassbjsg1": x[0] + "fierem",   "Vimppassbjsg2": x[0] + "fieres",   "Vimppassbjsg3": x[0] + "fieret",
            "Vimppassbjpl1": x[0] + "fieremus", "Vimppassbjpl2": x[0] + "fieretis", "Vimppassbjpl3": x[0] + "fierent",
            "Vprepasipesg2": x[0] + "fi",       "Vprepasipepl2": x[0] + "fite",
            "Vfutpasipesg2": x[0] + "fito",     "Vfutpasipesg3": x[0] + "fito",
            "Vfutpasipepl2": x[0] + "fitote",   "Vfutpasipepl3": x[0] + "fiunto",
            "Vprepasinf   ": x[0] + "fieri",
        },
        additions={},
        deletions=set(),
    ),
