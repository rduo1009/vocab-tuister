...
IRREGULAR_VERB_CHANGES: Final[dict[_IrregularVerb, DictChanges[Ending]]] = {
    "sum": DictChanges(  # sum, esse, fui, futurus
        ...
        # future active participles will not be generated
        # TODO: remove this when future active participle 4th pp is implemented
        additions={
            "Vfutactptcmnomsg": "futurus",
            "Vfutactptcmvocsg": "future",
            "Vfutactptcmaccsg": "futurum",
            "Vfutactptcmgensg": "futuri",
            "Vfutactptcmdatsg": "futuro",
            "Vfutactptcmablsg": "futuro",
            "Vfutactptcmnompl": "futuri",
            "Vfutactptcmvocpl": "futuri",
            "Vfutactptcmaccpl": "futuros",
            "Vfutactptcmgenpl": "futurorum",
            "Vfutactptcmdatpl": "futuris",
            "Vfutactptcmablpl": "futuris",
            "Vfutactptcfnomsg": "futura",
            "Vfutactptcfvocsg": "futura",
            "Vfutactptcfaccsg": "futuram",
            "Vfutactptcfgensg": "futurae",
            "Vfutactptcfdatsg": "futurae",
            "Vfutactptcfablsg": "futura",
            "Vfutactptcfnompl": "futurae",
            "Vfutactptcfvocpl": "futurae",
            "Vfutactptcfaccpl": "futuras",
            "Vfutactptcfgenpl": "futurarum",
            "Vfutactptcfdatpl": "futuris",
            "Vfutactptcfablpl": "futuris",
            "Vfutactptcnnomsg": "futurum",
            "Vfutactptcnvocsg": "futurum",
            "Vfutactptcnaccsg": "futurum",
            "Vfutactptcngensg": "futuri",
            "Vfutactptcndatsg": "futuro",
            "Vfutactptcnablsg": "futuro",
            "Vfutactptcnnompl": "futura",
            "Vfutactptcnvocpl": "futura",
            "Vfutactptcnaccpl": "futura",
            "Vfutactptcngenpl": "futurorum",
            "Vfutactptcndatpl": "futuris",
            "Vfutactptcnablpl": "futuris",
        },
    ...
    "volo": DictChanges(  # volo, velle, volui, voliturus
        ...
        # TODO: remove this when future active participle 4th pp is implemented
        additions={
            "Vfutactptcmnomsg": "voliturus",
            "Vfutactptcmvocsg": "voliture",
            "Vfutactptcmaccsg": "voliturum",
            "Vfutactptcmgensg": "volituri",
            "Vfutactptcmdatsg": "volituro",
            "Vfutactptcmablsg": "volituro",
            "Vfutactptcmnompl": "volituri",
            "Vfutactptcmvocpl": "volituri",
            "Vfutactptcmaccpl": "volituros",
            "Vfutactptcmgenpl": "voliturorum",
            "Vfutactptcmdatpl": "volituris",
            "Vfutactptcmablpl": "volituris",
            "Vfutactptcfnomsg": "volitura",
            "Vfutactptcfvocsg": "volitura",
            "Vfutactptcfaccsg": "volituram",
            "Vfutactptcfgensg": "voliturae",
            "Vfutactptcfdatsg": "voliturae",
            "Vfutactptcfablsg": "volitura",
            "Vfutactptcfnompl": "voliturae",
            "Vfutactptcfvocpl": "voliturae",
            "Vfutactptcfaccpl": "volituras",
            "Vfutactptcfgenpl": "voliturarum",
            "Vfutactptcfdatpl": "volituris",
            "Vfutactptcfablpl": "volituris",
            "Vfutactptcnnomsg": "voliturum",
            "Vfutactptcnvocsg": "voliturum",
            "Vfutactptcnaccsg": "voliturum",
            "Vfutactptcngensg": "volituri",
            "Vfutactptcndatsg": "volituro",
            "Vfutactptcnablsg": "volituro",
            "Vfutactptcnnompl": "volitura",
            "Vfutactptcnvocpl": "volitura",
            "Vfutactptcnaccpl": "volitura",
            "Vfutactptcngenpl": "voliturorum",
            "Vfutactptcndatpl": "volituris",
            "Vfutactptcnablpl": "volituris",
        },
        # no imperatives, passives
        deletions={re.compile(r"^.{4}pas.*$"), re.compile(r"^.{7}ipe.*$")},
    ),
...
DERIVED_IRREGULAR_CHANGES: Final[
    ...
    "sum": lambda x: DictChanges(  # e.g. adsum, adesse, adfui, adfuturus
        ...
        # TODO: remove this when future active participle 4th pp is implemented
        additions={
            "Vfutactptcmnomsg": f"{x[2]}futurus",
            "Vfutactptcmvocsg": f"{x[2]}future",
            "Vfutactptcmaccsg": f"{x[2]}futurum",
            "Vfutactptcmgensg": f"{x[2]}futuri",
            "Vfutactptcmdatsg": f"{x[2]}futuro",
            "Vfutactptcmablsg": f"{x[2]}futuro",
            "Vfutactptcmnompl": f"{x[2]}futuri",
            "Vfutactptcmvocpl": f"{x[2]}futuri",
            "Vfutactptcmaccpl": f"{x[2]}futuros",
            "Vfutactptcmgenpl": f"{x[2]}futurorum",
            "Vfutactptcmdatpl": f"{x[2]}futuris",
            "Vfutactptcmablpl": f"{x[2]}futuris",
            "Vfutactptcfnomsg": f"{x[2]}futura",
            "Vfutactptcfvocsg": f"{x[2]}futura",
            "Vfutactptcfaccsg": f"{x[2]}futuram",
            "Vfutactptcfgensg": f"{x[2]}futurae",
            "Vfutactptcfdatsg": f"{x[2]}futurae",
            "Vfutactptcfablsg": f"{x[2]}futura",
            "Vfutactptcfnompl": f"{x[2]}futurae",
            "Vfutactptcfvocpl": f"{x[2]}futurae",
            "Vfutactptcfaccpl": f"{x[2]}futuras",
            "Vfutactptcfgenpl": f"{x[2]}futurarum",
            "Vfutactptcfdatpl": f"{x[2]}futuris",
            "Vfutactptcfablpl": f"{x[2]}futuris",
            "Vfutactptcnnomsg": f"{x[2]}futurum",
            "Vfutactptcnvocsg": f"{x[2]}futurum",
            "Vfutactptcnaccsg": f"{x[2]}futurum",
            "Vfutactptcngensg": f"{x[2]}futuri",
            "Vfutactptcndatsg": f"{x[2]}futuro",
            "Vfutactptcnablsg": f"{x[2]}futuro",
            "Vfutactptcnnompl": f"{x[2]}futura",
            "Vfutactptcnvocpl": f"{x[2]}futura",
            "Vfutactptcnaccpl": f"{x[2]}futura",
            "Vfutactptcngenpl": f"{x[2]}futurorum",
            "Vfutactptcndatpl": f"{x[2]}futuris",
            "Vfutactptcnablpl": f"{x[2]}futuris",
        },
        # no passives, present participles
        deletions={re.compile(r"^.{4}pas.*$"), re.compile(r"^.preactptc.*$")},
    ),
