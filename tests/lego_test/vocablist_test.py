...
def test_vocablist():
    ...
    assert repr(l) == f"VocabList([Verb(audio, audire, audivi, auditus, hear), Adjective(bonus, bona, bonum, None, 212, good), RegularWord(e, from), Pronoun(ille, that), Noun(nomen, nominis, neuter, name)], version={src.__version__})"
