...
def test_vocablist():
    ...
    assert l.__repr__() == f"VocabList([Verb(audio, audire, audivi, auditus, hear), Adjective(bonus, bona, bonum, None, 212, good), RegularWord(e, from), Pronoun(ille, that), Noun(nomen, nominis, neuter, name)], version={src.__version__})"
...
def test_vocablist_add():
    ...
    list_2 = VocabList([Verb("audio", "audire", "audivi", "auditus", meaning="listen"), Noun("templum", "templi", gender=Gender.NEUTER, meaning="shrine"), Adjective("laetus", "laeta", "laetum", declension="212", meaning="joyful"), RegularWord("e", meaning="out"), Pronoun("ille", meaning="that")])
